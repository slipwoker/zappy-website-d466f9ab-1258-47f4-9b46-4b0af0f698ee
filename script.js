    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "baduk imports בדוק ייבוא משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'd466f9ab-1258-47f4-9b46-4b0af0f698ee',
                    name: data.name || '',
                    email: data.email || '',
